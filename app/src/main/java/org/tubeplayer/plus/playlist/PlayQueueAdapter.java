...
import org.tubeplayer.plus.playlist.events.AppendEvent;
import org.tubeplayer.plus.playlist.events.ErrorEvent;
...
import org.tubeplayer.plus.playlist.events.SelectEvent;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int type) {
        switch(type) {
            ...
            case ITEM_VIEW_TYPE_ID:
                return new PlayQueueItemHolder(LayoutInflater.from(parent.getContext()).inflate(org.tubeplayer.plus.R.layout.play_queue_item, parent, false));
            default:
