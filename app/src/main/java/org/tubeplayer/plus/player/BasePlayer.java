...
import org.tubeplayer.plus.Downloader;
import org.tubeplayer.plus.history.HistoryRecordManager;
import org.tubeplayer.plus.player.helper.AudioReactor;
import org.tubeplayer.plus.player.helper.LoadController;
import org.tubeplayer.plus.player.helper.MediaSessionManager;
import org.tubeplayer.plus.player.helper.PlayerDataSource;
import org.tubeplayer.plus.player.helper.PlayerHelper;
import org.tubeplayer.plus.player.playback.BasePlayerMediaSession;
import org.tubeplayer.plus.player.playback.CustomTrackSelector;
import org.tubeplayer.plus.player.playback.MediaSourceManager;
import org.tubeplayer.plus.player.playback.PlaybackListener;
import org.tubeplayer.plus.playlist.PlayQueue;
import org.tubeplayer.plus.playlist.PlayQueueAdapter;
import org.tubeplayer.plus.playlist.PlayQueueItem;
import org.tubeplayer.plus.util.SerializedCache;
...
public abstract class BasePlayer implements
    ...
    public void showStreamError(Exception exception) {
        ...
        if (errorToast == null) {
            errorToast = Toast.makeText(context, org.tubeplayer.plus.R.string.player_stream_failure, Toast.LENGTH_SHORT);
            errorToast.show();
        }
    }
    ...
    public void showRecoverableError(Exception exception) {
        ...
        if (errorToast == null) {
            errorToast = Toast.makeText(context, org.tubeplayer.plus.R.string.player_recoverable_failure, Toast.LENGTH_SHORT);
            errorToast.show();
        }
    }
    ...
    public void showUnrecoverableError(Exception exception) {
        ...
        errorToast = Toast.makeText(context, org.tubeplayer.plus.R.string.player_unrecoverable_failure, Toast.LENGTH_SHORT);
        errorToast.show();
    }
    ...
    public String getVideoUrl() {
        return currentItem == null ? context.getString(org.tubeplayer.plus.R.string.unknown_content) : currentItem.getUrl();
    }

    public String getVideoTitle() {
        return currentItem == null ? context.getString(org.tubeplayer.plus.R.string.unknown_content) : currentItem.getTitle();
    }

    public String getUploaderName() {
        return currentItem == null ? context.getString(org.tubeplayer.plus.R.string.unknown_content) : currentItem.getUploader();
    }
