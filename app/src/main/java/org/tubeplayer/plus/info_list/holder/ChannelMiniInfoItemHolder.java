...
public class ChannelMiniInfoItemHolder extends InfoItemHolder {
    ...
    ChannelMiniInfoItemHolder(InfoItemBuilder infoItemBuilder, int layoutId, ViewGroup parent) {
        ...
        itemAdditionalDetailView = itemView.findViewById(org.tubeplayer.plus.R.id.itemAdditionalDetails);
    }

    public ChannelMiniInfoItemHolder(InfoItemBuilder infoItemBuilder, ViewGroup parent) {
        this(infoItemBuilder, org.tubeplayer.plus.R.layout.list_channel_mini_item, parent);
    }
