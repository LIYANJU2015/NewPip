...
public class StreamMiniInfoItemHolder extends InfoItemHolder {
    ...
    public StreamMiniInfoItemHolder(InfoItemBuilder infoItemBuilder, ViewGroup parent) {
        this(infoItemBuilder, org.tubeplayer.plus.R.layout.list_stream_mini_item, parent);
    }
    ...
    public void updateFromItem(final InfoItem infoItem) {
        ...
        if (item.getDuration() > 0) {
            ...
            itemDurationView.setText(org.tubeplayer.plus.R.string.duration_live);
            itemDurationView.setBackgroundColor(ContextCompat.getColor(itemBuilder.getContext(),
                    org.tubeplayer.plus.R.color.live_duration_background_color));
            itemDurationView.setVisibility(View.VISIBLE);
        } else {
