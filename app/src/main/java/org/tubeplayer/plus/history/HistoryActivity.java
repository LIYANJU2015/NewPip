...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.tubeplayer.plus.R.layout.activity_history);
...
//        toolbar.setBackgroundColor(color);
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle(org.tubeplayer.plus.R.string.title_activity_history);
        }
        ...
        mViewPager = findViewById(org.tubeplayer.plus.R.id.container);
        mViewPager.setAdapter(mSectionsPagerAdapter);

        TabLayout tabLayout = findViewById(org.tubeplayer.plus.R.id.tabs);
        tabLayout.setupWithViewPager(mViewPager);

        final FloatingActionButton fab = findViewById(org.tubeplayer.plus.R.id.fab);
        RxView.clicks(fab)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(org.tubeplayer.plus.R.menu.menu_history, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(org.tubeplayer.plus.R.string.title_history_search);
                case 1:
                    return getString(org.tubeplayer.plus.R.string.title_history_view);
            }
            throw new IllegalArgumentException("position: " + position);
        }
