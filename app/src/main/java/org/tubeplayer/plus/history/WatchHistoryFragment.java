...
import org.tubeplayer.plus.database.history.model.StreamHistoryEntry;
...
public class WatchHistoryFragment extends HistoryFragment<StreamHistoryEntry> {
    ...
    int getEnabledConfigKey() {
        return org.tubeplayer.plus.R.string.enable_watch_history_key;
    }
    ...
    public void onHistoryItemLongClick(StreamHistoryEntry item) {
        new AlertDialog.Builder(activity)
                .setTitle(item.title)
                .setMessage(org.tubeplayer.plus.R.string.delete_stream_history_prompt)
                .setCancelable(true)
                .setNeutralButton(org.tubeplayer.plus.R.string.cancel, null)
                .setPositiveButton(org.tubeplayer.plus.R.string.delete_one, (dialog, i) -> {
                    ...
                    makeSnackbar(org.tubeplayer.plus.R.string.item_deleted);
                })
                .setNegativeButton(org.tubeplayer.plus.R.string.delete_all, (dialog, i) -> {
    ...
    private static class StreamHistoryAdapter extends HistoryEntryAdapter<StreamHistoryEntry, ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View itemView = inflater.inflate(org.tubeplayer.plus.R.layout.list_stream_item, parent, false);
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            thumbnailView = itemView.findViewById(org.tubeplayer.plus.R.id.itemThumbnailView);
            info = itemView.findViewById(org.tubeplayer.plus.R.id.itemAdditionalDetails);
            streamTitle = itemView.findViewById(org.tubeplayer.plus.R.id.itemVideoTitleView);
            uploader = itemView.findViewById(org.tubeplayer.plus.R.id.itemUploaderView);
            duration = itemView.findViewById(org.tubeplayer.plus.R.id.itemDurationView);
        }
    }
}
