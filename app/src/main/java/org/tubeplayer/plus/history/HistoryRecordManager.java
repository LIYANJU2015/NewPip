...
public class HistoryRecordManager {
    ...
    public HistoryRecordManager(final Context context) {
        ...
        searchHistoryKey = context.getString(org.tubeplayer.plus.R.string.enable_search_history_key);
        streamHistoryKey = context.getString(org.tubeplayer.plus.R.string.enable_watch_history_key);
    }
