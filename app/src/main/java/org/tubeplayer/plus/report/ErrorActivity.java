package org.tubeplayer.plus.report;
...
import org.tubeplayer.plus.ActivityCommunicator;
...
public class ErrorActivity extends AppCompatActivity {
    ...
    public static void reportUiError(final AppCompatActivity activity, final Throwable el) {
        reportError(activity, el, activity.getClass(), null,
                ErrorInfo.make(UserAction.UI_ERROR, "none", "", org.tubeplayer.plus.R.string.app_ui_crash));
    }
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.tubeplayer.plus.R.layout.activity_error);
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(org.tubeplayer.plus.R.string.error_report_title);
            actionBar.setDisplayShowTitleEnabled(true);
        }

        reportButton = findViewById(org.tubeplayer.plus.R.id.errorReportButton);
        userCommentBox = findViewById(org.tubeplayer.plus.R.id.errorCommentBox);
        errorView = findViewById(org.tubeplayer.plus.R.id.errorView);
        infoView = findViewById(org.tubeplayer.plus.R.id.errorInfosView);
        errorMessageView = findViewById(org.tubeplayer.plus.R.id.errorMessageView);
        ...
        if (errorInfo.message != 0) {
            ...
            findViewById(org.tubeplayer.plus.R.id.messageWhatHappenedView).setVisibility(View.GONE);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(org.tubeplayer.plus.R.menu.error_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case android.R.id.home:
                goToReturnActivity();
                break;
            case org.tubeplayer.plus.R.id.menu_item_share_error: {
                Intent intent = new Intent();
                intent.setAction(Intent.ACTION_SEND);
                intent.putExtra(Intent.EXTRA_TEXT, buildJson());
                intent.setType("text/plain");
                startActivity(Intent.createChooser(intent, getString(org.tubeplayer.plus.R.string.share_dialog_title)));
            }
            break;
        }
        return false;
    ...
    private void buildInfo(ErrorInfo info) {
        TextView infoLabelView = findViewById(org.tubeplayer.plus.R.id.errorInfoLabelsView);
        TextView infoView = findViewById(org.tubeplayer.plus.R.id.errorInfosView);
        String text = "";

        infoLabelView.setText(getString(org.tubeplayer.plus.R.string.info_labels).replace("\\n", "\n"));
    ...
    private String getContentLangString() {
        return PreferenceManager.getDefaultSharedPreferences(this)
                .getString(this.getString(org.tubeplayer.plus.R.string.content_country_key), "none");
    }
    ...
    private void addGuruMeditaion() {
        //just an easter egg
        TextView sorryView = findViewById(org.tubeplayer.plus.R.id.errorSorryView);
        String text = sorryView.getText().toString();
        text += "\n" + getString(org.tubeplayer.plus.R.string.guru_meditation);
