...
import org.tubeplayer.plus.fragments.local.bookmark.BookmarkFragment;
import org.tubeplayer.plus.fragments.subscription.SubscriptionFragment;
...
public class MainFragment extends BaseFragment implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(org.tubeplayer.plus.R.layout.fragment_main, container, false);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        SubMenu kioskMenu = menu.addSubMenu(Menu.NONE, Menu.NONE, 200, getString(org.tubeplayer.plus.R.string.kiosk));
        if (App.isSuper()) {
            ...
            switch (position) {
                ...
                case 2:
                    if(PreferenceManager.getDefaultSharedPreferences(getActivity())
                            .getString(getString(org.tubeplayer.plus.R.string.main_page_content_key), getString(org.tubeplayer.plus.R.string.blank_page_key))
                            .equals(getString(org.tubeplayer.plus.R.string.subscription_page_key))) {
    ...
    private Fragment getMainPageFragment() {
        ...
        try {
            ...
            final String setMainPage = preferences.getString(getString(org.tubeplayer.plus.R.string.main_page_content_key),
                    getString(org.tubeplayer.plus.R.string.main_page_selectd_kiosk_id));
            if (setMainPage.equals(getString(org.tubeplayer.plus.R.string.blank_page_key))) {
                return new BlankFragment();
            } else if (setMainPage.equals(getString(org.tubeplayer.plus.R.string.kiosk_page_key))) {
                int serviceId = preferences.getInt(getString(org.tubeplayer.plus.R.string.main_page_selected_service),
                        FALLBACK_SERVICE_ID);
                String kioskId = preferences.getString(getString(org.tubeplayer.plus.R.string.main_page_selectd_kiosk_id),
                        FALLBACK_KIOSK_ID);
                KioskFragment fragment = KioskFragment.getInstance(serviceId, kioskId);
                fragment.useAsFrontPage(true);
                return fragment;
            } else if (setMainPage.equals(getString(org.tubeplayer.plus.R.string.feed_page_key))) {
                FeedFragment fragment = new FeedFragment();
                fragment.useAsFrontPage(true);
                return fragment;
            } else if (setMainPage.equals(getString(org.tubeplayer.plus.R.string.channel_page_key))) {
                int serviceId = preferences.getInt(getString(org.tubeplayer.plus.R.string.main_page_selected_service),
                        FALLBACK_SERVICE_ID);
                String url = preferences.getString(getString(org.tubeplayer.plus.R.string.main_page_selected_channel_url),
                        FALLBACK_CHANNEL_URL);
                String name = preferences.getString(getString(org.tubeplayer.plus.R.string.main_page_selected_channel_name),
