package org.tubeplayer.plus.fragments.list.search;
...
import org.tubeplayer.plus.fragments.list.BaseListFragment;
import org.tubeplayer.plus.history.HistoryRecordManager;
...
import org.tubeplayer.plus.util.LayoutManagerSmoothScroller;
...
import org.tubeplayer.plus.views.AdViewWrapperAdapter;
...
public class SearchFragment
    ...
    public void onAttach(Context context) {
        ...
        isSearchHistoryEnabled = preferences.getBoolean(getString(org.tubeplayer.plus.R.string.enable_search_history_key), true);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(org.tubeplayer.plus.R.layout.fragment_search, container, false);
    }
    ...
    protected void initViews(View rootView, Bundle savedInstanceState) {
        ...
        suggestionsPanel = rootView.findViewById(org.tubeplayer.plus.R.id.suggestions_panel);
        suggestionsRecyclerView = rootView.findViewById(org.tubeplayer.plus.R.id.suggestions_list);
        ...
        searchToolbarContainer = activity.findViewById(org.tubeplayer.plus.R.id.toolbar_search_container);
        searchEditText = searchToolbarContainer.findViewById(org.tubeplayer.plus.R.id.toolbar_search_edit_text);
        searchClear = searchToolbarContainer.findViewById(org.tubeplayer.plus.R.id.toolbar_search_clear);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(org.tubeplayer.plus.R.menu.menu_search, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case org.tubeplayer.plus.R.id.menu_filter_all:
            case org.tubeplayer.plus.R.id.menu_filter_video:
            case org.tubeplayer.plus.R.id.menu_filter_channel:
            case org.tubeplayer.plus.R.id.menu_filter_playlist:
    ...
    private void initSearchListeners() {
        ...
        TooltipCompat.setTooltipText(searchClear, getString(org.tubeplayer.plus.R.string.clear));
    ...
    private void showDeleteSuggestionDialog(final SuggestionItem item) {
        ...
        new AlertDialog.Builder(activity)
                .setTitle(query)
                .setMessage(org.tubeplayer.plus.R.string.delete_item_search_history)
                .setCancelable(true)
                .setNegativeButton(org.tubeplayer.plus.R.string.cancel, null)
                .setPositiveButton(org.tubeplayer.plus.R.string.delete, (dialog, which) -> {
                    final Disposable onDelete = historyRecordManager.deleteSearchHistory(query)
                            ...
                            .subscribe(
                                    ...
                                    throwable -> showSnackBarError(throwable,
                                            ...
                                            "Deleting item failed", org.tubeplayer.plus.R.string.general_error)
                            );
                ...
                disposables.add(Observable
                        ...
                        .subscribe(new Consumer<Intent>() {
                            ...
                            public void accept(Throwable throwable) throws Exception {
                                showError(getString(org.tubeplayer.plus.R.string.url_not_supported_toast), false);
                            }
                        }));
                return;
            }
    ...
    public void onSuggestionError(Throwable exception) {
        ...
        int errorId = exception instanceof ParsingException ? org.tubeplayer.plus.R.string.parsing_error : org.tubeplayer.plus.R.string.general_error;
