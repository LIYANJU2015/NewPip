package org.tubeplayer.plus.fragments.list.playlist;
...
import org.tubeplayer.plus.playlist.PlaylistPlayQueue;
...
public class PlaylistFragment extends BaseListInfoFragment<PlaylistInfo> {
    ...
    protected View getListHeader() {
        headerRootLayout = activity.getLayoutInflater().inflate(org.tubeplayer.plus.R.layout.playlist_header, itemsList, false);
        headerTitleView = headerRootLayout.findViewById(org.tubeplayer.plus.R.id.playlist_title_view);
        headerUploaderLayout = headerRootLayout.findViewById(org.tubeplayer.plus.R.id.uploader_layout);
        headerUploaderName = headerRootLayout.findViewById(org.tubeplayer.plus.R.id.uploader_name);
        headerUploaderAvatar = headerRootLayout.findViewById(org.tubeplayer.plus.R.id.uploader_avatar_view);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(org.tubeplayer.plus.R.menu.menu_playlist, menu);

        playlistBookmarkButton = menu.findItem(org.tubeplayer.plus.R.id.menu_item_bookmark);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case org.tubeplayer.plus.R.id.menu_item_share:
                shareUrl(name, url);
                break;
            case org.tubeplayer.plus.R.id.menu_item_bookmark:
                onBookmarkClicked();
                break;
            default:
    ...
    public void handleResult(@NonNull final PlaylistInfo result) {
        ...
        headerStreamCount.setText(getResources().getQuantityString(org.tubeplayer.plus.R.plurals.videos,
    ...
    private void updateBookmarkButtons() {
        ...
        final int iconAttr = playlistEntity == null ?
                org.tubeplayer.plus.R.drawable.ic_playlist_add_white_24dp : org.tubeplayer.plus.R.drawable.ic_playlist_add_check_white_24dp;

        final int titleRes = playlistEntity == null ?
                org.tubeplayer.plus.R.string.bookmark_playlist : org.tubeplayer.plus.R.string.unbookmark_playlist;
