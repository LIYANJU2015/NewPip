...
public abstract class BaseListFragment<I, N> extends BaseStateFragment<I> implements ListViewContract<I, N>, StateSaver.WriteRead {
    ...
    protected View getListFooter() {
        return activity.getLayoutInflater().inflate(org.tubeplayer.plus.R.layout.pignate_footer, itemsList, false);
    }
    ...
    protected void showStreamDialog(final StreamInfoItem item) {
        ...
        final String[] commands = new String[]{
                ...
                context.getResources().getString(org.tubeplayer.plus.R.string.append_playlist)
        };
