...
public class ImportConfirmationDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        return new AlertDialog.Builder(getContext(), org.tubeplayer.plus.R.style.LightDialogTheme)
                .setMessage(org.tubeplayer.plus.R.string.import_network_expensive_warning)
                .setCancelable(true)
