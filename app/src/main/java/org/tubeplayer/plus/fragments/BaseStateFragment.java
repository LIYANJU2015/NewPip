...
public abstract class BaseStateFragment<I> extends BaseFragment implements ViewContract<I> {
    ...
    protected void initViews(View rootView, Bundle savedInstanceState) {
        ...
        emptyStateView = rootView.findViewById(org.tubeplayer.plus.R.id.empty_state_view);
        loadingProgressBar = rootView.findViewById(org.tubeplayer.plus.R.id.loading_progress_bar);

        errorPanelRoot = rootView.findViewById(org.tubeplayer.plus.R.id.error_panel);
        errorButtonRetry = rootView.findViewById(org.tubeplayer.plus.R.id.error_button_retry);
        errorTextView = rootView.findViewById(org.tubeplayer.plus.R.id.error_message_view);
    }
    ...
    protected boolean onError(Throwable exception) {
        ...
        if (exception instanceof ReCaptchaException) {
            ...
            showError(getString(org.tubeplayer.plus.R.string.network_error), true);
            return true;
        }
    ...
    public void onReCaptchaException() {
        ...
        Toast.makeText(activity, org.tubeplayer.plus.R.string.recaptcha_request_toast, Toast.LENGTH_LONG).show();
        // Starting ReCaptcha Challenge Activity
        startActivityForResult(new Intent(activity, ReCaptchaActivity.class), ReCaptchaActivity.RECAPTCHA_REQUEST);

        showError(getString(org.tubeplayer.plus.R.string.recaptcha_request_toast), false);
    }
    ...
    protected void openUrlInBrowser(String url) {
        ...
        startActivity(Intent.createChooser(intent, activity.getString(org.tubeplayer.plus.R.string.share_dialog_title)));
    }
