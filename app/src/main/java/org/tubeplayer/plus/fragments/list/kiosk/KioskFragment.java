package org.tubeplayer.plus.fragments.list.kiosk;
...
//        }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(org.tubeplayer.plus.R.layout.fragment_kiosk, container, false);
        return view;
    }
    ...
    public Single<KioskInfo> loadResult(boolean forceReload) {
        String contentCountry = PreferenceManager
                ...
                .getString(getString(org.tubeplayer.plus.R.string.content_country_key),
                        getString(org.tubeplayer.plus.R.string.default_country_value));
