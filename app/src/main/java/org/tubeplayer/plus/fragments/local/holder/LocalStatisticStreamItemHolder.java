...
public class LocalStatisticStreamItemHolder extends LocalItemHolder {
    ...
    public LocalStatisticStreamItemHolder(LocalItemBuilder infoItemBuilder, ViewGroup parent) {
        super(infoItemBuilder, org.tubeplayer.plus.R.layout.list_stream_item, parent);
        ...
        itemAdditionalDetails = itemView.findViewById(org.tubeplayer.plus.R.id.itemAdditionalDetails);
    }
