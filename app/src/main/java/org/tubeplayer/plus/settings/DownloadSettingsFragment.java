...
public class DownloadSettingsFragment extends BasePreferenceFragment {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        addPreferencesFromResource(org.tubeplayer.plus.R.xml.download_settings);
    }

    private void initKeys() {
        DOWNLOAD_PATH_PREFERENCE = getString(org.tubeplayer.plus.R.string.download_path_key);
        DOWNLOAD_PATH_AUDIO_PREFERENCE = getString(org.tubeplayer.plus.R.string.download_path_audio_key);
    }

    private void updatePreferencesSummary() {
        findPreference(DOWNLOAD_PATH_PREFERENCE).setSummary(defaultPreferences.getString(DOWNLOAD_PATH_PREFERENCE, getString(org.tubeplayer.plus.R.string.download_path_summary)));
        findPreference(DOWNLOAD_PATH_AUDIO_PREFERENCE).setSummary(defaultPreferences.getString(DOWNLOAD_PATH_AUDIO_PREFERENCE, getString(org.tubeplayer.plus.R.string.download_path_audio_summary)));
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if ((requestCode == REQUEST_DOWNLOAD_PATH || requestCode == REQUEST_DOWNLOAD_AUDIO_PATH)
            ...
            String key = getString(requestCode == REQUEST_DOWNLOAD_PATH ? org.tubeplayer.plus.R.string.download_path_key : org.tubeplayer.plus.R.string.download_path_audio_key);
