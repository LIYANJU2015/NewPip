...
public class Utils {
    ...
    public static void setStatusColor(Activity activity) {
        int color = ServiceHelper.getSelectedServiceId(activity) == 0 ? ContextCompat.getColor(activity, org.playtube.plus.R.color.light_youtube_primary_color)
                : ContextCompat.getColor(activity, org.playtube.plus.R.color.light_soundcloud_primary_color);
