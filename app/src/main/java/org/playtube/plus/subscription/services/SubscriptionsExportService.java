...
public class SubscriptionsExportService extends BaseImportExportService {
    ...
    @Override
    public int getTitle() {
        return org.playtube.plus.R.string.export_ongoing;
    }
    ...
    private void startExport() {
        showToast(org.playtube.plus.R.string.export_ongoing);
    ...
    private Subscriber<File> getSubscriber() {
        return new Subscriber<File>() {
            ...
            public void onComplete() {
                ...
                showToast(org.playtube.plus.R.string.export_complete_toast);
                stopService();
            }
        };
    }
    ...
    protected void handleError(Throwable error) {
        super.handleError(org.playtube.plus.R.string.subscriptions_export_unsuccessful, error);
    }
}
