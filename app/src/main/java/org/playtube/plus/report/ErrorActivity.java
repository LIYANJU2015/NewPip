package org.playtube.plus.report;
...
import org.playtube.plus.ActivityCommunicator;
...
public class ErrorActivity extends AppCompatActivity {
    ...
    public static void reportUiError(final AppCompatActivity activity, final Throwable el) {
        reportError(activity, el, activity.getClass(), null,
                ErrorInfo.make(UserAction.UI_ERROR, "none", "", org.playtube.plus.R.string.app_ui_crash));
    }
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.playtube.plus.R.layout.activity_error);
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(org.playtube.plus.R.string.error_report_title);
            actionBar.setDisplayShowTitleEnabled(true);
        }

        reportButton = findViewById(org.playtube.plus.R.id.errorReportButton);
        userCommentBox = findViewById(org.playtube.plus.R.id.errorCommentBox);
        errorView = findViewById(org.playtube.plus.R.id.errorView);
        infoView = findViewById(org.playtube.plus.R.id.errorInfosView);
        errorMessageView = findViewById(org.playtube.plus.R.id.errorMessageView);
        ...
        if (errorInfo.message != 0) {
            ...
            findViewById(org.playtube.plus.R.id.messageWhatHappenedView).setVisibility(View.GONE);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(org.playtube.plus.R.menu.error_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case android.R.id.home:
                goToReturnActivity();
                break;
            case org.playtube.plus.R.id.menu_item_share_error: {
                Intent intent = new Intent();
                intent.setAction(Intent.ACTION_SEND);
                intent.putExtra(Intent.EXTRA_TEXT, buildJson());
                intent.setType("text/plain");
                startActivity(Intent.createChooser(intent, getString(org.playtube.plus.R.string.share_dialog_title)));
            }
            break;
        }
        return false;
    ...
    private void buildInfo(ErrorInfo info) {
        TextView infoLabelView = findViewById(org.playtube.plus.R.id.errorInfoLabelsView);
        TextView infoView = findViewById(org.playtube.plus.R.id.errorInfosView);
        String text = "";

        infoLabelView.setText(getString(org.playtube.plus.R.string.info_labels).replace("\\n", "\n"));
    ...
    private String getContentLangString() {
        return PreferenceManager.getDefaultSharedPreferences(this)
                .getString(this.getString(org.playtube.plus.R.string.content_country_key), "none");
    }
    ...
    private void addGuruMeditaion() {
        //just an easter egg
        TextView sorryView = findViewById(org.playtube.plus.R.id.errorSorryView);
        String text = sorryView.getText().toString();
        text += "\n" + getString(org.playtube.plus.R.string.guru_meditation);
