...
public class WatchHistoryFragment extends HistoryFragment<StreamHistoryEntry> {
    ...
    int getEnabledConfigKey() {
        return org.playtube.plus.R.string.enable_watch_history_key;
    }
    ...
    public void onHistoryItemLongClick(StreamHistoryEntry item) {
        new AlertDialog.Builder(activity)
                .setTitle(item.title)
                .setMessage(org.playtube.plus.R.string.delete_stream_history_prompt)
                .setCancelable(true)
                .setNeutralButton(org.playtube.plus.R.string.cancel, null)
                .setPositiveButton(org.playtube.plus.R.string.delete_one, (dialog, i) -> {
                    ...
                    makeSnackbar(org.playtube.plus.R.string.item_deleted);
                })
                .setNegativeButton(org.playtube.plus.R.string.delete_all, (dialog, i) -> {
    ...
    private static class StreamHistoryAdapter extends HistoryEntryAdapter<StreamHistoryEntry, ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View itemView = inflater.inflate(org.playtube.plus.R.layout.list_stream_item, parent, false);
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            thumbnailView = itemView.findViewById(org.playtube.plus.R.id.itemThumbnailView);
            info = itemView.findViewById(org.playtube.plus.R.id.itemAdditionalDetails);
            streamTitle = itemView.findViewById(org.playtube.plus.R.id.itemVideoTitleView);
            uploader = itemView.findViewById(org.playtube.plus.R.id.itemUploaderView);
            duration = itemView.findViewById(org.playtube.plus.R.id.itemDurationView);
        }
    }
}
