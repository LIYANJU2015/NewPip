...
public class SearchHistoryFragment extends HistoryFragment<SearchHistoryEntry> {
    ...
    int getEnabledConfigKey() {
        return org.playtube.plus.R.string.enable_search_history_key;
    }
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            search = itemView.findViewById(org.playtube.plus.R.id.search);
            info = itemView.findViewById(org.playtube.plus.R.id.info);
        }
    }
    ...
    protected class SearchHistoryAdapter extends HistoryEntryAdapter<SearchHistoryEntry, ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View rootView = inflater.inflate(org.playtube.plus.R.layout.item_search_history, parent, false);
