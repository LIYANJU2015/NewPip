...
public class StreamMiniInfoItemHolder extends InfoItemHolder {
    ...
    StreamMiniInfoItemHolder(InfoItemBuilder infoItemBuilder, int layoutId, ViewGroup parent) {
        ...
        itemUploaderView = itemView.findViewById(org.playtube.plus.R.id.itemUploaderView);
    ...
    public StreamMiniInfoItemHolder(InfoItemBuilder infoItemBuilder, ViewGroup parent) {
        this(infoItemBuilder, org.playtube.plus.R.layout.list_stream_mini_item, parent);
    }
    ...
    public void updateFromItem(final InfoItem infoItem) {
        ...
        if (item.getDuration() > 0) {
            ...
            itemDurationView.setText(org.playtube.plus.R.string.duration_live);
            itemDurationView.setBackgroundColor(ContextCompat.getColor(itemBuilder.getContext(),
                    org.playtube.plus.R.color.live_duration_background_color));
            itemDurationView.setVisibility(View.VISIBLE);
        } else {
