...
public class ChannelInfoItemHolder extends ChannelMiniInfoItemHolder {
    ...
    public ChannelInfoItemHolder(InfoItemBuilder infoItemBuilder, ViewGroup parent) {
        super(infoItemBuilder, org.playtube.plus.R.layout.list_channel_item, parent);
        itemChannelDescriptionView = itemView.findViewById(org.playtube.plus.R.id.itemChannelDescriptionView);
    }
