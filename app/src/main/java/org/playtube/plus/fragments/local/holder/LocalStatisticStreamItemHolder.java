...
public class LocalStatisticStreamItemHolder extends LocalItemHolder {
    ...
    public LocalStatisticStreamItemHolder(LocalItemBuilder infoItemBuilder, ViewGroup parent) {
        super(infoItemBuilder, org.playtube.plus.R.layout.list_stream_item, parent);
        ...
        itemAdditionalDetails = itemView.findViewById(org.playtube.plus.R.id.itemAdditionalDetails);
    }
