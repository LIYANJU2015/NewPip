...
import org.playtube.plus.database.AppDatabase;
...
public final class BookmarkFragment
    ...
    protected View getListHeader() {
        final View headerRootLayout = activity.getLayoutInflater()
                .inflate(org.playtube.plus.R.layout.bookmark_header, itemsList, false);
        lastPlayedButton = headerRootLayout.findViewById(org.playtube.plus.R.id.lastPlayed);
        mostPlayedButton = headerRootLayout.findViewById(org.playtube.plus.R.id.mostPlayed);
    ...
    protected boolean onError(Throwable exception) {
        ...
        onUnrecoverableError(exception, UserAction.SOMETHING_ELSE,
                "none", "Bookmark", org.playtube.plus.R.string.general_error);
        return true;
    }
    ...
    private void showDeleteDialog(final String name, final Single<Integer> deleteReactor) {
        ...
        new AlertDialog.Builder(activity)
                .setTitle(name)
                .setMessage(org.playtube.plus.R.string.delete_playlist_prompt)
                .setCancelable(true)
                .setPositiveButton(org.playtube.plus.R.string.delete, (dialog, i) ->
