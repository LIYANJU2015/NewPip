package org.playtube.plus.fragments.list.playlist;
...
import org.playtube.plus.fragments.local.RemotePlaylistManager;
import org.playtube.plus.info_list.InfoItemDialog;
import org.playtube.plus.playlist.PlayQueue;
import org.playtube.plus.playlist.PlaylistPlayQueue;
...
public class PlaylistFragment extends BaseListInfoFragment<PlaylistInfo> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(org.playtube.plus.R.layout.fragment_playlist, container, false);
    }
    ...
    protected View getListHeader() {
        headerRootLayout = activity.getLayoutInflater().inflate(org.playtube.plus.R.layout.playlist_header, itemsList, false);
        headerTitleView = headerRootLayout.findViewById(org.playtube.plus.R.id.playlist_title_view);
        headerUploaderLayout = headerRootLayout.findViewById(org.playtube.plus.R.id.uploader_layout);
        headerUploaderName = headerRootLayout.findViewById(org.playtube.plus.R.id.uploader_name);
        headerUploaderAvatar = headerRootLayout.findViewById(org.playtube.plus.R.id.uploader_avatar_view);
        headerStreamCount = headerRootLayout.findViewById(org.playtube.plus.R.id.playlist_stream_count);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(org.playtube.plus.R.menu.menu_playlist, menu);

        playlistBookmarkButton = menu.findItem(org.playtube.plus.R.id.menu_item_bookmark);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case org.playtube.plus.R.id.menu_item_share:
                shareUrl(name, url);
                break;
            case org.playtube.plus.R.id.menu_item_bookmark:
                onBookmarkClicked();
                break;
            default:
    ...
    public void handleResult(@NonNull final PlaylistInfo result) {
        ...
        headerStreamCount.setText(getResources().getQuantityString(org.playtube.plus.R.plurals.videos,
    ...
    private void updateBookmarkButtons() {
        ...
        final int iconAttr = playlistEntity == null ?
                org.playtube.plus.R.drawable.ic_playlist_add_white_24dp : org.playtube.plus.R.drawable.ic_playlist_add_check_white_24dp;

        final int titleRes = playlistEntity == null ?
                org.playtube.plus.R.string.bookmark_playlist : org.playtube.plus.R.string.unbookmark_playlist;
