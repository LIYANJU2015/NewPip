...
public class LocalPlaylistStreamItemHolder extends LocalItemHolder {
    ...
    LocalPlaylistStreamItemHolder(LocalItemBuilder infoItemBuilder, int layoutId, ViewGroup parent) {
        ...
        itemVideoTitleView = itemView.findViewById(org.playtube.plus.R.id.itemVideoTitleView);
        itemAdditionalDetailsView = itemView.findViewById(org.playtube.plus.R.id.itemAdditionalDetails);
        itemDurationView = itemView.findViewById(org.playtube.plus.R.id.itemDurationView);
        itemHandleView = itemView.findViewById(org.playtube.plus.R.id.itemHandle);
    }

    public LocalPlaylistStreamItemHolder(LocalItemBuilder infoItemBuilder, ViewGroup parent) {
        this(infoItemBuilder, org.playtube.plus.R.layout.list_stream_playlist_item, parent);
    }
    ...
    public void updateFromItem(final LocalItem localItem, final DateFormat dateFormat) {
        ...
        if (item.duration > 0) {
            ...
            itemDurationView.setBackgroundColor(ContextCompat.getColor(itemBuilder.getContext(),
                    org.playtube.plus.R.color.duration_background_color));
