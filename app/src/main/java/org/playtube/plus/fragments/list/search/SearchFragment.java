package org.playtube.plus.fragments.list.search;
...
import org.playtube.plus.fragments.list.BaseListFragment;
...
import org.playtube.plus.util.LayoutManagerSmoothScroller;
...
import org.playtube.plus.views.AdViewWrapperAdapter;
...
public class SearchFragment
    ...
    public void onAttach(Context context) {
        ...
        isSearchHistoryEnabled = preferences.getBoolean(getString(org.playtube.plus.R.string.enable_search_history_key), true);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(activity);
        isSuggestionsEnabled = preferences.getBoolean(getString(org.playtube.plus.R.string.show_search_suggestions_key), true);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(org.playtube.plus.R.layout.fragment_search, container, false);
    }
    ...
    protected void initViews(View rootView, Bundle savedInstanceState) {
        ...
        suggestionsPanel = rootView.findViewById(org.playtube.plus.R.id.suggestions_panel);
        suggestionsRecyclerView = rootView.findViewById(org.playtube.plus.R.id.suggestions_list);
        ...
        searchToolbarContainer = activity.findViewById(org.playtube.plus.R.id.toolbar_search_container);
        searchEditText = searchToolbarContainer.findViewById(org.playtube.plus.R.id.toolbar_search_edit_text);
        searchClear = searchToolbarContainer.findViewById(org.playtube.plus.R.id.toolbar_search_clear);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(org.playtube.plus.R.menu.menu_search, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case org.playtube.plus.R.id.menu_filter_all:
            case org.playtube.plus.R.id.menu_filter_video:
            case org.playtube.plus.R.id.menu_filter_channel:
            case org.playtube.plus.R.id.menu_filter_playlist:
    ...
    private void initSearchListeners() {
        ...
        TooltipCompat.setTooltipText(searchClear, getString(org.playtube.plus.R.string.clear));
    ...
    private void showDeleteSuggestionDialog(final SuggestionItem item) {
        ...
        new AlertDialog.Builder(activity)
                .setTitle(query)
                .setMessage(org.playtube.plus.R.string.delete_item_search_history)
                .setCancelable(true)
                .setNegativeButton(org.playtube.plus.R.string.cancel, null)
                .setPositiveButton(org.playtube.plus.R.string.delete, (dialog, which) -> {
                    final Disposable onDelete = historyRecordManager.deleteSearchHistory(query)
                            ...
                            .subscribe(
                                    ...
                                    throwable -> showSnackBarError(throwable,
                                            ...
                                            "Deleting item failed", org.playtube.plus.R.string.general_error)
                            );
                ...
                disposables.add(Observable
                        ...
                        .subscribe(new Consumer<Intent>() {
                            ...
                            public void accept(Throwable throwable) throws Exception {
                                showError(getString(org.playtube.plus.R.string.url_not_supported_toast), false);
                            }
                        }));
                return;
            }
    ...
    public void onSuggestionError(Throwable exception) {
        ...
        int errorId = exception instanceof ParsingException ? org.playtube.plus.R.string.parsing_error : org.playtube.plus.R.string.general_error;
