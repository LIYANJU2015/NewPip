...
public final class PopupVideoPlayer extends Service {
    ...
    public void onCreate() {
        ...
        setTheme(org.playtube.plus.R.style.DarkTheme);
    ...
    private void initPopup() {
        ...
        View rootView = View.inflate(this, org.playtube.plus.R.layout.player_popup, null);
        playerImpl.setup(rootView);

        youtubeIconView = rootView.findViewById(org.playtube.plus.R.id.youtube_icon);
        ...
        final float defaultSize = getResources().getDimension(org.playtube.plus.R.dimen.popup_default_width);
    ...
    private NotificationCompat.Builder createNotification() {
        notRemoteView = new RemoteViews(BuildConfig.APPLICATION_ID, org.playtube.plus.R.layout.player_popup_notification);

        if (playerImpl != null) {
            notRemoteView.setTextViewText(org.playtube.plus.R.id.notificationSongName, playerImpl.getVideoTitle());
            notRemoteView.setTextViewText(org.playtube.plus.R.id.notificationArtist, playerImpl.getUploaderName());
        }

        notRemoteView.setOnClickPendingIntent(org.playtube.plus.R.id.notificationPlayPause,
                PendingIntent.getBroadcast(this, NOTIFICATION_ID, new Intent(ACTION_PLAY_PAUSE), PendingIntent.FLAG_UPDATE_CURRENT));
        notRemoteView.setOnClickPendingIntent(org.playtube.plus.R.id.notificationStop,
                PendingIntent.getBroadcast(this, NOTIFICATION_ID, new Intent(ACTION_CLOSE), PendingIntent.FLAG_UPDATE_CURRENT));
        notRemoteView.setOnClickPendingIntent(org.playtube.plus.R.id.notificationRepeat,
        ...
        notRemoteView.setOnClickPendingIntent(org.playtube.plus.R.id.notificationContent,
        ...
        return new NotificationCompat.Builder(this, getString(org.playtube.plus.R.string.notification_channel_id))
                .setOngoing(true)
    ...
    private void updateNotification(int drawableId) {
        ...
        if (drawableId != -1) notRemoteView.setImageViewResource(org.playtube.plus.R.id.notificationPlayPause, drawableId);
    ...
    private void updateScreenSize() {
        ...
        popupWidth = getResources().getDimension(org.playtube.plus.R.dimen.popup_default_width);
        popupHeight = getMinimumVideoHeight(popupWidth);

        minimumWidth = getResources().getDimension(org.playtube.plus.R.dimen.popup_minimum_width);
    ...
    protected void setRepeatModeRemote(final RemoteViews remoteViews, final int repeatMode) {
        ...
        switch (repeatMode) {
            case Player.REPEAT_MODE_OFF:
                remoteViews.setInt(org.playtube.plus.R.id.notificationRepeat, methodName, org.playtube.plus.R.drawable.exo_controls_repeat_off);
                break;
            case Player.REPEAT_MODE_ONE:
                remoteViews.setInt(org.playtube.plus.R.id.notificationRepeat, methodName, org.playtube.plus.R.drawable.exo_controls_repeat_one);
                break;
            case Player.REPEAT_MODE_ALL:
                remoteViews.setInt(org.playtube.plus.R.id.notificationRepeat, methodName, org.playtube.plus.R.drawable.exo_controls_repeat_all);
                break;
        }
    }
    ...
    protected class VideoPlayerImpl extends VideoPlayer implements View.OnLayoutChangeListener {
        ...
        public void initViews(View rootView) {
            ...
            resizingIndicator = rootView.findViewById(org.playtube.plus.R.id.resizing_indicator);
            fullScreenButton = rootView.findViewById(org.playtube.plus.R.id.fullScreenButton);
        ...
        public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
            ...
            if (loadedImage != null) {
                ...
                if (notRemoteView != null) {
                    notRemoteView.setImageViewBitmap(org.playtube.plus.R.id.notificationCover, loadedImage);
                }
        ...
        public void onPaused() {
            super.onPaused();
            updateNotification(org.playtube.plus.R.drawable.ic_play_arrow_white);
            showAndAnimateControl(org.playtube.plus.R.drawable.ic_play_arrow_white, false);
        ...
        public void onCompleted() {
            ...
            showAndAnimateControl(org.playtube.plus.R.drawable.ic_replay_white, false);
            lockManager.releaseWifiAndCpu();
        }
