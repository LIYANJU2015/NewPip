...
public final class PopupVideoPlayerActivity extends ServicePlayerActivity {
    ...
    public String getSupportActionTitle() {
        return getResources().getString(org.playtube.plus.R.string.title_activity_popup_player);
    }
    ...
    public int getPlayerOptionMenuResource() {
        return org.playtube.plus.R.menu.menu_play_queue_popup;
    }

    @Override
    public boolean onPlayerOptionSelected(MenuItem item) {
        if (item.getItemId() == org.playtube.plus.R.id.action_switch_background) {
