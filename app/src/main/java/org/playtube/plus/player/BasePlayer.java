...
import org.playtube.plus.Downloader;
import org.playtube.plus.history.HistoryRecordManager;
import org.playtube.plus.player.helper.AudioReactor;
import org.playtube.plus.player.helper.LoadController;
import org.playtube.plus.player.helper.MediaSessionManager;
import org.playtube.plus.player.helper.PlayerDataSource;
import org.playtube.plus.player.helper.PlayerHelper;
import org.playtube.plus.player.playback.BasePlayerMediaSession;
import org.playtube.plus.player.playback.CustomTrackSelector;
import org.playtube.plus.player.playback.MediaSourceManager;
import org.playtube.plus.player.playback.PlaybackListener;
import org.playtube.plus.playlist.PlayQueue;
import org.playtube.plus.playlist.PlayQueueAdapter;
import org.playtube.plus.playlist.PlayQueueItem;
import org.playtube.plus.util.SerializedCache;
...
public abstract class BasePlayer implements
    ...
    public void showStreamError(Exception exception) {
        ...
        if (errorToast == null) {
            errorToast = Toast.makeText(context, org.playtube.plus.R.string.player_stream_failure, Toast.LENGTH_SHORT);
            errorToast.show();
        }
    }
    ...
    public void showRecoverableError(Exception exception) {
        ...
        if (errorToast == null) {
            errorToast = Toast.makeText(context, org.playtube.plus.R.string.player_recoverable_failure, Toast.LENGTH_SHORT);
            errorToast.show();
        }
    }
    ...
    public void showUnrecoverableError(Exception exception) {
        ...
        errorToast = Toast.makeText(context, org.playtube.plus.R.string.player_unrecoverable_failure, Toast.LENGTH_SHORT);
        errorToast.show();
    }
    ...
    public String getVideoUrl() {
        return currentItem == null ? context.getString(org.playtube.plus.R.string.unknown_content) : currentItem.getUrl();
    }

    public String getVideoTitle() {
        return currentItem == null ? context.getString(org.playtube.plus.R.string.unknown_content) : currentItem.getTitle();
    }

    public String getUploaderName() {
        return currentItem == null ? context.getString(org.playtube.plus.R.string.unknown_content) : currentItem.getUploader();
    }
