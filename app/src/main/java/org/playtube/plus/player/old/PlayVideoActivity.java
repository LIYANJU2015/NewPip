package org.playtube.plus.player.old;
...
public class PlayVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.playtube.plus.R.layout.activity_play_video);
        setVolumeControlStream(AudioManager.STREAM_MUSIC);

        //set background arrow style
        getSupportActionBar().setHomeAsUpIndicator(org.playtube.plus.R.drawable.ic_arrow_back_white_24dp);
        ...
        videoView = findViewById(org.playtube.plus.R.id.video_view);
        progressBar = findViewById(org.playtube.plus.R.id.play_video_progress_bar);
        try {
        ...
        Button button = findViewById(org.playtube.plus.R.id.content_button);
    ...
    public boolean onCreatePanelMenu(int featured, Menu menu) {
        ...
        inflater.inflate(org.playtube.plus.R.menu.video_player, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id) {
            ...
            case org.playtube.plus.R.id.menu_item_share:
                ...
                break;
            case org.playtube.plus.R.id.menu_item_screen_rotation:
                toggleOrientation();
                break;
            default:
